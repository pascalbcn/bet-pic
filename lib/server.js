...
server.get('/Games', _GameController2.default.getGames);
server.get('/Games/id/:id', _GameController2.default.getGame);
server.get('/Games/create', _GameController2.default.getCreateGame);
server.post('/Games/create', _GameController2.default.postCreateGame);
server.get('/Games/update/:id', _GameController2.default.getUpdateGame);
server.post('/Games/update/:id', _GameController2.default.postUpdateGame);
server.get('/Games/delete/:id', _GameController2.default.getDeleteGame);
...
server.get('/api/Games', _GameController2.default.getGamesApi);
server.get('/api/Games/id/:id', _GameController2.default.getGameApi);
server.post('/api/Games/create', _GameController2.default.postCreateGameApi);
server.post('/api/Games/update/:id', _GameController2.default.postUpdateGameApi);
server.post('/api/Games/delete/:id', _GameController2.default.postDeleteGameApi);
